...
export const Form = ({formType, formTitle,submitBtn}) => {
        ...
        {(()=>{
            ...
            switch(true){
                case formType === 'login':{
                    return(
                        <>
                    <InputType labelText={'Email Address'} labelFor={'forEmail'} inputType={'email'} name={'email'} value={email} onChange={(e) => setEmail(e.target.value)} />
